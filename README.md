...
Relational Databases are the databases set up to hold information, SQL is the language used to interact with them.

- [ ] Why do tables need a `primary key`?

To have a unique value for each row.
...
An intermediary table to hold foreign keys that reference the primary keys on the related tables.
